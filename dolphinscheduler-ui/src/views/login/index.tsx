        ...
        <div class={styles['login-model']}>
          <div class={styles.title}>
            <div style="display: flex; justify-content: center; margin-bottom: 16px;">
              <img src={LogoImage} alt="Logo" style="height: 64px; max-width: 200px; object-fit: contain;" />
            </div>
            <h2>工业互联网故障检测与质量管理平台</h2>
            <div class={styles.subtitle}>
              IoT 数据接入 · 算法训练 · 质量评估 · 结果回传
            </div>
          </div>
          <div
          ...
          <NSpace class={styles['oauth2-provider']} justify='center'>
            ...
            {this.oidcProviders?.map((e: OidcProvider) => {
              const authUrl = `/IndustrialManagementPlatform/oauth2/authorization/${e.id}`
              return (
