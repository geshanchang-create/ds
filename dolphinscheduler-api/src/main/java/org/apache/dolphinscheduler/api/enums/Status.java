...
public enum Status {
    ...
    ALGORITHM_EXECUTION_ID_NOT_FOUND(1500003,
            ...
            "任务实例[{0}]中没有输出变量[{1}]"),
    ALGORITHM_EXECUTION_ID_INVALID(1500004, "task instance {0} contains an invalid algorithm execution id",
            "任务实例[{0}]中的算法执行ID无效"),
    ALGORITHM_TASK_RESULT_NOT_READY(1500005, "task instance {0} has not completed successfully",
            "任务实例[{0}]尚未成功完成"),
    ALGORITHM_RESULT_NOT_READY(1500006, "algorithm execution {0} result is not ready",
            "算法执行[{0}]的结果尚未就绪"),
    ALGORITHM_RESULT_NOT_FOUND(1500007, "algorithm execution {0} result was not found",
            "未找到算法执行[{0}]的结果"),
    ALGORITHM_RESULT_INVALID(1500008, "algorithm execution {0} returned an invalid normalized result",
            "算法执行[{0}]返回的标准化结果无效"),
    ALGORITHM_PLATFORM_AUTHENTICATION_FAILED(1500009, "algorithm platform authentication failed",
            "算法平台身份验证失败"),
    ALGORITHM_PLATFORM_UNAVAILABLE(1500010, "algorithm platform is unavailable for execution {0}",
            "算法执行[{0}]暂时无法访问算法平台"),
